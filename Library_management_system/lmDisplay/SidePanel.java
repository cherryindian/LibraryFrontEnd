...
public class SidePanel extends JPanel {
    ...
    SidePanel() {
        ...
        setPreferredSize(new Dimension(155, 2000)); // Set your preferred width
        setVisible(true);
    }
    ...
    private void setButtonProperties(JButton button, String panel) {
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                // Increase font size and set a whiter color on hovering
                button.setFont(new Font(originalFont.getName(), Font.BOLD, fontSize + 2));
                button.setForeground(Color.WHITE);
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                // Restore original font size and color on exit
